/*
 * Problem Description:
 * Implement Cocktail Sort algorithm.
 * Cocktail Sort is a variation of Bubble sort. The Bubble sort algorithm always traverses 
 * elements from left and moves the largest element to its correct position in first iteration and second largest in second and so on.
